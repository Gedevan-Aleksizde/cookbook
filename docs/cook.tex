...
\def\labelenumi{\arabic{enumi}.}
\item
  米をザルに入れて短時間冷水ですすぎながらほぐし, 水気を良く切る
...
\item
  ...
  \item
    ...
    \url{https://www.youtube.com/watch?v=3gF44PXZXNc}
  \item
    中華鍋で丁寧に作る場合の解説 (日本語)
...
\hypertarget{shakushka}{%
\section{シャクシュカ (中近東)}\label{shakushka}}

中近東および北アフリカで見られる料理.
西紅柿炒鶏蛋同様トマトと卵の料理だが,
唐辛子ソースのハリッサやオリーブオイルを加えるのでもう少し豪華になる
(図\ref{fig:shakushuka-finished}).
...
\caption{シャクシュカの例}\label{fig:shakushuka-finished}
\end{figure}
...
\item
  玉ねぎとニンニクをみじん切りにする
\item
  フライパンにオリーブオイルをひき, 玉ねぎとニンニクを火が通るまで炒める
\item
  トマトとハリッサを入れ, よくかき混ぜる
\item
  トマトに火が通って余計な水分が減り, 柔らかくなるま煮込む
\item
  卵を投入する
...
\item
  卵に十分に火が通ったら皿に盛り付ける
\item
  刻んだオリーブの実とコリアンダーの葉を散らす
\end{enumerate}

\hypertarget{ux88dcux8db3-5}{%
\subsection{補足}\label{ux88dcux8db3-5}}

KALDI で売っているハリッサを使うと楽だが,
ちょっと割高なので材料を直接入れても良い.
...
\tightlist
\item
  アラブ式シャクシュカ (アラビア語, 英語字幕)
  \url{https://www.youtube.com/watch?v=aSTBwIeYBYk}
\item
  (英語) \url{https://www.youtube.com/watch?v=Iy3mUtlvw84}
\item
  モロッコ式シャクシュカ (英語)
  \url{https://www.youtube.com/watch?v=9z9UU10kM5c}
\end{itemize}
...
\subsection{補足}\label{ux88dcux8db3-6}}
...
\subsubsection{補足}\label{ux88dcux8db3-7}}
...
\subsection{補足}\label{ux88dcux8db3-8}}

ベーコンはさほど重要ではない. 必須なのはジャガイモ.

\hypertarget{ux53c2ux8003ux8cc7ux6599-6}{%
\subsection{参考資料}\label{ux53c2ux8003ux8cc7ux6599-6}}
...
\subsubsection{参考資料}\label{ux53c2ux8003ux8cc7ux6599-7}}
...
\item
  \textcite{faktor2007Traditional} p.~18
\end{itemize}
...
\subsubsection{補足}\label{ux88dcux8db3-10}}
...
\hypertarget{ux6750ux6599-2ux98dfux5206-3}{%
\subsection{材料 (2食分)}\label{ux6750ux6599-2ux98dfux5206-3}}
...
\item
  ...
  \item
    その2 (古いバージョン)
    \url{https://www.youtube.com/watch?v=DIMwUp9UqB4}
  \end{itemize}
\end{itemize}
...
\item
  \textcite{czerniecki1682Compendium} pp.86-87 (ほとんど読めない)
\end{itemize}
...
\item
  \textcite{OginoNumano2017} p.~54
\item
  \textcite{boumei} Ch. 27, および付録のサラファン式レシピ
\end{itemize}
...
\hypertarget{ux30e9ux30b0ux30deux30f3-ux30a6ux30a4ux30b0ux30eb-uxfedfuxfeeauxfbd5uxfee4uxfeeauxfee6}{%
\section{\texorpdfstring{ラグマン (ウイグル:
{ﻟﻪﯕﻤﻪﻦ})\index{うどん!ラグマン}}{ラグマン (ウイグル: ﻟﻪﯕﻤﻪﻦ)}}\label{ux30e9ux30b0ux30deux30f3-ux30a6ux30a4ux30b0ux30eb-uxfedfuxfeeauxfbd5uxfee4uxfeeauxfee6}}

ウイグル族をはじめ中央アジア各所で見られる料理.
中国語の「拉麺」の由来と考えられる. 日本のラーメンと違い,
本来の語義通り手延べ麺であることが特徴. スープに漬けるものもあれば,
「混ぜそば」「焼きそば」風のものもあるが,
今回は簡単な混ぜそば風のものにする.
...
\tightlist
\item
  \textcite{faktor2007Traditional} p.65
\item
...
\tightlist
\item
  \textcite{faktor2007Traditional} p.54
\item
...
\item
  \textcite{OginoNumano2017} pp.~40-41
\end{itemize}
...
という料理もある\autocite{faktor2007Traditional}.
...
\item
  \textcite{faktor2007Traditional}, p.~58
\end{itemize}
...
(図\ref{fig:kharcho-finished}). \textcite{boumei}
...
ボルシチに似ているが肉を使わない,
冷たい料理.「液体のサラダ」とでもいうべき料理(図\ref{saltibarsciai-finished})
...
\tightlist
\item
  \textcite{faktor2007Traditional} p.24
\item
...
\tightlist
\item
  \textcite{faktor2007Traditional} p.50
\item
...
\caption{ボルシチ}\label{fig:finished-borscht}
\end{figure}
...
\item
  \textcite{OginoNumano2017} pp.~36-37
\end{itemize}
...
\textcite{OginoNumano2017} によればキノコのカーシャ,
または炊き込みご飯とも相性が良い.
...
\tightlist
\item
  \textcite{OginoNumano2017} pp.~42-43
\end{itemize}
...
\item
  ...
  \url{https://www.youtube.com/watch?time_continue=1\&v=5FbGKARjuBU\&feature=emb_logo}
\item
  Čočka na kyselo の料理動画 (英語)
  \url{https://www.youtube.com/watch?v=0uVRiei7yxk\&feature=emb_logo}
\end{itemize}
...
\caption{すりつぶしたレンズ豆}\label{fig:unnamed-chunk-50}
\end{figure}
...
\caption{中世のロールパン}\label{fig:unnamed-chunk-54}
\end{figure}
...
\caption{「ソーセージ」}\label{fig:unnamed-chunk-56}
\end{figure}
...
\hypertarget{ux30d1ux30f3ux7c89ux306eux30c9ux30fcux30caux30c4-ux6377-16ux4e16ux7d00}{%
\section{パン粉のドーナツ (捷,
16世紀)}\label{ux30d1ux30f3ux7c89ux306eux30c9ux30fcux30caux30c4-ux6377-16ux4e16ux7d00}}
...
\hypertarget{ux30cfux30f3ux30acux30eaux30fcux98a8ux725bux8089-ux6377-15ux4e16ux7d00-hovux11bzuxed-po-uhersku}{%
\section{\texorpdfstring{ハンガリー風牛肉 (捷, 15世紀, hovězí po
Uhersku)
\index{hovězí po Uhersku|see{ハンガリー風牛肉}}}{ハンガリー風牛肉 (捷, 15世紀, hovězí po Uhersku) }}\label{ux30cfux30f3ux30acux30eaux30fcux98a8ux725bux8089-ux6377-15ux4e16ux7d00-hovux11bzuxed-po-uhersku}}
...
\item
  Random Innkeeper の動画
\item
  \textcite{feyfrlikova2015Kuchyne} pp.~80-81
\end{itemize}

\hypertarget{ux30cfux30f3ux30acux30eaux30fcux98a8ux30edux30fcux30b9ux30c8ux30d3ux30fcux30d5-ux6377-16ux4e16ux7d00-hovux11bzie-po-uhersku}{%
\section{\texorpdfstring{「ハンガリー風」ローストビーフ (捷, 16世紀,
hovězie po Uhersku)
\index{hovězie po Uhersku|see{ハンガリー風ローストビーフ}}}{「ハンガリー風」ローストビーフ (捷, 16世紀, hovězie po Uhersku) }}\label{ux30cfux30f3ux30acux30eaux30fcux98a8ux30edux30fcux30b9ux30c8ux30d3ux30fcux30d5-ux6377-16ux4e16ux7d00-hovux11bzie-po-uhersku}}
...
ロールプレイがしたい人は注意. なお \textcite{feyfrlikova2015Kuchyne}
...
\caption{現代モラヴィア風}\label{fig:roast-duck-cz-finished}
\end{figure}
...
\hypertarget{ux30bfux30e9ux306eux30d9ux30fcux30b3ux30f3ux7092ux3081-ux6377-15ux4e16ux7d00-ux161tiku-s-slaninami}{%
\section{タラのベーコン炒め (捷, 15世紀: Štiku s
slaninami)}\label{ux30bfux30e9ux306eux30d9ux30fcux30b3ux30f3ux7092ux3081-ux6377-15ux4e16ux7d00-ux161tiku-s-slaninami}}

イギリス由来の料理のため, 海の魚を使用している.
メルルーサとかを使うのが本来のレシピだが,
手に入れやすいスケトウダラでアレンジ.
...
\textcite{Ju2018} p.~23 でも中世イギリスのタラ料理が言及されている.
...
\tightlist
\item
  \textcite{Damerow2012SumerianBT}
\item
  \textcite{GojkoEtAl2019-blog}
\item
  \textcite{GojkoEtAl2019}
\item
  これらを元にした自作記録
